...
<form action="${pageContext.request.contextPath}/member/queryMemberList" method="post">
    <div class="formbody">
        <ul class="seachform">
            ...
            <li><label>姓名</label><input id="memName" name="memName" type="text" class="scinput" value="${memName}"/>
            </li>
...
<div class="rightinfo">
    <div class="tools">
        <ul class="toolbar1">
            <li><a href="${pageContext.request.contextPath}/view/manager/userInfoAdd.jsp"><span><img
    ...
    <table class="tablelist">
        ...
        <c:forEach items="${info.list}" var="mm">
            <tr>
                ...
                <td width="20%">
                    <a href="${pageContext.request.contextPath}/member/beforeUpdate?memid=${mm.memId}"><img
                            src="${pageContext.request.contextPath}/images/t02.png"/></a>修改&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/member/deleteMember?memid=${mm.memId}"><img
                            src="${pageContext.request.contextPath}/images/t03.png"/></a>删除&nbsp;&nbsp;
                    <c:if test="${mm.isenable=='T'}">
                        <img src="${pageContext.request.contextPath}/images/t08.png" height="24" width="24"
                             onclick="isenable('${mm.memId}','${mm.isenable}')"/>禁用&nbsp;&nbsp;
                    </c:if>
                    <c:if test="${mm.isenable=='F'}">
                        <img src="${pageContext.request.contextPath}/images/t09.png" height="24" width="24"
                             onclick="isenable('${mm.memId}','${mm.isenable}')"/>启用&nbsp;&nbsp;
                    </c:if>
                    <a href="${pageContext.request.contextPath}/member/resetPass?memid=${mm.memId}"><img
                            src="${pageContext.request.contextPath}/images/t07.png" height="20" width="20"/></a>重置密码
                </td>
            </tr>
        </c:forEach>
        </tbody>
